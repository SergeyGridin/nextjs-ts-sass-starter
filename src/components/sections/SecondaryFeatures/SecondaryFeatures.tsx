...
const features = [
  {
    ...
    image: '/assets/images/screenshots/profit-loss.png',
  ...
  },
  {
    ...
    image: '/assets/images/screenshots/contacts.png',
            ...
            <div className="-mx-5 flex">
              {features.map((feature, featureIndex) => (
                <Tab.Panel
                  ...
                  key={feature.name}
                  className={clsx(
                    '[&:not(:focus-visible)]:focus:outline-none px-5 transition duration-500 ease-in-out',
                    {
